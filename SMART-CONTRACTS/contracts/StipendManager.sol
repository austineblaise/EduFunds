...
contract StipendManager is Ownable {
    ...
    event StipendAssigned(address indexed student, uint256 amount, uint256 unlockDate);
    ...
    function assignStipend(address student, uint256 amount, uint256 unlockDate) external onlyOwner {
        ...
        stipends[student].push(Stipend(amount, unlockDate, false));

        emit StipendAssigned(student, amount, unlockDate);
    }
